...
const AttributionForm: React.FC<AttributionFormProps> = ({ 
  ...
  }, [simName, funnelStages, objective, mode]); // Remove onFormDataChange from dependencies
  ...
  const handleSubmit = async () => {
    ...
    try {      // Prepare the simulation data
